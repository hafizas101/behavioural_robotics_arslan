...
def read_environment(file_path):
    ...
    if maze_env.test_wall_collision(loc):
    	print("")
    	print("[INFO] ==> The given starting position collides with the wall. Please change it from environment text file.")
    	print("")
    	sys.exit()
    print("User defined starting location: "+str(loc))
